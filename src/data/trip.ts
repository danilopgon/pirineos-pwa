...
const activities: Activity[] = [
  {
    "id": "aigualluts",
    "area": "llanos-hospital",
    "areaLabel": "Llanos del Hospital",
    "category": "montana",
    "effort": "medio",
    "duration": "dia-completo",
    "combinability": "standalone",
    "title": "Forau de Aigualluts",
    "short": "Aigualluts",
    "tags": [
      "Sin bus, a pie desde el parking"
    ],
    "stats": {
      "distanceKm": 13,
      "ascentM": 400,
  ...
  },
  {
    ...
    "affinities": [
      {
        "activityId": "banos-benasque",
        "weight": 3,
        "reason": "Están a un kilómetro."
      }
    ]
  },
  {
    ...
    "accessLinks": [
      {
        ...
        "href": "https://museodiocesano.es/entradas/",
        "ghost": true
      }
    ],
    "routeHeading": "El día, ordenado",
    ...
    "affinities": [
      {
        "activityId": "ainsa",
        "weight": 1,
        "reason": "Encaja si se acepta más coche."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affinities": [
      {
        "activityId": "cerler-ampriu",
        "weight": 2,
        "reason": "Cerler queda como salida propia, no dentro del paseo."
      }
    ]
  },
  {
    ...
    "accessLinks": [
      {
        "label": "Avisos del parque",
        "href": "https://pnomp.es/es/avisos",
        "ghost": true
      }
    ],
  ...
  {
    "id": "pueblos-vio",
    "title": "Ruta panorámica de Vió, Buerba y Fanlo",
    "area": "anisclo",
    ...
    "affinities": [
      {
        "activityId": "ainsa",
        "weight": 2,
        "reason": "Se puede cerrar comiendo allí."
      }
    ]
  },
  {
    ...
    "affinities": [
      {
        "activityId": "bielsa-chistau",
        "weight": 1,
        "reason": "Bielsa queda en el mismo lado del viaje."
      }
    ]
  },
  {
    ...
    "affinities": [
      {
        "activityId": "cerler-ampriu",
        "weight": 2,
        "reason": "Comparten la subida a Cerler."
      }
    ]
  },
  {
    "id": "picos-cerler-gallinero",
    "title": "Pico Cerler o Gallinero desde el Ampriu",
    "area": "cerler",
    "areaLabel": "Ampriu",
    "category": "montana",
    ...
    "variants": [
      ...
      },
      {
        ...
        "summary": [
          "Cima de 2.728 m con una de las mejores panorámicas del valle. Es la opción que conserva una subida seria."
        ]
      }
    ]
  },
  {
    "id": "banos-benasque",
    "title": "Pozas termales de los Baños de Benasque",
    "area": "benasque",
    ...
    "affinities": [
      {
        "activityId": "gorgas-alba",
        "weight": 3,
        "reason": "Salen de aparcamientos contiguos."
      }
    ]
  },
  {
    "id": "spa-benasque",
    "title": "Spa de pago, sin salir del pueblo",
    "area": "benasque",
    "areaLabel": "Benasque",
    "category": "relax",
    "effort": "muy-bajo",
  ...
  {
    "id": "bielsa-chistau",
    "title": "Bielsa y el valle de Chistau",
    "area": "bielsa-chistau",
  ...
  {
    "id": "paso-nuevo",
    "title": "Embalse de Paso Nuevo y presa de Benasque",
    "area": "benasque",
    "areaLabel": "Valle de Benasque",
    "category": "paseo",
    "effort": "muy-bajo",
  ...
  {
    "id": "congosto-ventamillo",
    "title": "Congosto de Ventamillo",
    "area": "ribagorza",
    "areaLabel": "Ribagorza",
    "category": "paseo",
    "effort": "muy-bajo",
  ...
  {
    "id": "benasque-eriste",
    "title": "Benasque–Eriste",
    "area": "benasque",
    "areaLabel": "Benasque y Eriste",
    "category": "paseo",
    "effort": "bajo",
    "duration": "corta",
    "combinability": "facil",
  ...
  {
    "id": "eriste-anciles",
    "title": "Eriste–Anciles",
    "area": "benasque",
    "areaLabel": "Eriste y Anciles",
    "category": "paseo",
    "effort": "bajo",
    "duration": "corta",
    "combinability": "facil",
  ...
  {
    "id": "linsoles-guayente-sahun",
    "title": "Linsoles, Guayente y Sahún",
    "area": "solano",
    "areaLabel": "Solano",
    "category": "pueblos",
    "effort": "bajo",
    ...
    "affinities": [
      {
        "activityId": "ardones",
        "weight": 2,
        "reason": "Comparten la carretera de Cerler."
      }
    ]
  }
]
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "links": [
          {
            "label": "Instalar Organic Maps",
            "href": "https://omaps.app/get"
          }
        ],
        "widget": "puntos",
        "id": "points-batch"

...
export const labels = {
  ...
  today: {
    ...
    dayButton: (day: number) => `Preparar el día ${day}`,
    dayPlan: (day: number) => `Plan del día ${day}`,
    plannedHeading: 'Lo que habéis añadido',
    activitySummary: (area: string, duration: string) => `${area} · ${duration}`,
  ...
  catalogue: {
    heading: 'Explorar',
    intro: 'Elige una actividad y añádela al día actual.',
    ...
    added: 'Añadida al día actual',
    add: 'Añadir',
    remove: 'Quitar',
    details: 'Ver detalle',
    addActivity: (title: string) => `Añadir ${title} al día actual`,
    removeActivity: (title: string) => `Quitar ${title} del día actual`,
